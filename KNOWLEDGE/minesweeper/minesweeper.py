...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        self.mark_safe(cell)
        #3.
        undetermined_cells,mines_count = set(), count
        ...
        if len(undetermined_cells) > 0:
            self.knowledge.append(Sentence(undetermined_cells, mines_count))
        #4. and 5.
        k_changed=True # k_changed is used to check if any knowledge was changed
        while k_changed:
            k_changed=False
            new_safes = set()
            new_mines = set()
